...
/**
 * @ClassName HosProblem
 * @Auther: YaJun
 * @Date: 2021 - 03 - 30 - 17:59
 * @Description: com.zyj.Pojo
 * @version: 1.0
 */
public class HosProblem {
  ...
  CONSTRAINT `hospitalize_question_ibfk_4` FOREIGN KEY (`h_name`) REFERENCES `hospitalize_rational` (`h_name`)
    ...
    public Integer getTreat_id() {
        return treat_id;
    }

    public void setTreat_id(Integer treat_id) {
