...
S2.define('select2/options',[
  ...
  Options.prototype.fromElement = function ($e) {
    ...
    if ($e.data('ajaxUrl')) {
      if (this.options.debug && window.console && console.warn) {
        console.warn(
          'Select2: The `data-Servlet-url` attribute has been changed to ' +
          '`data-Servlet--url` and support for the old attribute will be removed' +
          ' in future versions of Select2.'
        );
      }

      $e.attr('Servlet--url', $e.data('ajaxUrl'));
      $e.data('Servlet--url', $e.data('ajaxUrl'));
    }
