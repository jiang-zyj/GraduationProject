...
$(function () {
    js.initTabPage("tabpanel", {
        height: function () {
            var g = $(window).height(), e = $(".mail-header:visible").outerHeight(),
                f = $(".mail-footer:visible").outerHeight(), d = g - e - f;
            return d < 300 ? 300 : d
        }
    });
    $(window).resize();
...
+function (h) {
    ...
    var b = {
        ...
        mainFooter: ".mail-footer:visible",
        mainHeader: ".mail-header:visible",
        sidebar: ".sidebar",
        controlSidebar: ".control-sidebar",
        fixed: ".fixed",
        sidebarMenu: ".sidebar-menu",
        logo: ".mail-header .logo"
    };
